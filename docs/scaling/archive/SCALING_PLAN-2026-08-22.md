...
> 使用原则：任务级状态与实施证据以 OpenSpec changes/specs（[scaling-docs-baseline](../../openspec/specs/scaling-docs-baseline/spec.md)）与 `docs/tasks/phase1-storage/` 为准；本文件只保留架构结论与 roadmap 状态。
