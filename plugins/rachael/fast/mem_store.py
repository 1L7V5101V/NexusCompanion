"""
MemoryStore —— 纯内存版 RachaelStore，duck-type 出 RachaelReplayRuntime 用到的方法。
...
from plugins.rachael.core import (
    RachaelNode, EDGE_DECAY_TAU, advance_salience_state, causal_salience,
