...
import { MetricTile, TrendChart, Sparkline, Chip, api, type ChartTone } from "@nexus/dashboard-ui";
...
function ErrorDrill({
  ...
  const gotoSession = (key: string): void => {
    window.dispatchEvent(new CustomEvent("nexus:goto-session", { detail: key }));
    close();
  };
