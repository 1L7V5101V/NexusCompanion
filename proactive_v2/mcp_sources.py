...
读取 ~/.nexus/workspace/proactive_sources.json 中的配置，
...
_SOURCES_CONFIG = Path.home() / ".nexus/workspace/proactive_sources.json"
_MCP_SERVERS_CONFIG = Path.home() / ".nexus/workspace/mcp_servers.json"
